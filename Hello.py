...
Door een beperkt aantal stappen te volgen en een keuze te maken over uw laadstrategie krijgt u direct beter inzicht in de mogelijkheden voor elektrificatie van uw wagenpark. De applicatie neemt u hierin stap voor stap mee. Meer informatie kunt u krijgen door over de (i) tekentjes te gaan. Heeft u toch behoefte aan een volledige handleiding, dan is deze <a href="https://filebrowser-production-98b8.up.railway.app/api/public/dl/cYXEu_yl">hier</a> te downloaden.<br><br> Dit project is gefinancierd met middelen uit het project Green Transport Delta Elektrificatie en in samenwerking tussen TNO en het Nationaal Kennisplatform Laadinfrastructuur (NKL) tot stand gekomen.
