    ...
    #                         "Dit is onvoldoende/voldoende")
        ...
        with col8:
            for x in range(ritdata["VoertuigNr"].nunique()):
                ...
                exec(f'tekst8_{x} = "Verbruik per kilometer: " + str(ritdata2["Verbruik"].max())')
        ...
        def generate_pdf():
            ...
            for x in range(ritdata["VoertuigNr"].nunique()):
                ...
                exec(f'pdf.cell(200, 10, txt=tekst1_{x} , ln=1, align="L")')
                pdf.set_font('Open Sans', style="", size=8)
                exec(f'pdf.cell(200, 10, txt=tekst2_{x} , ln=1, align="L")')
